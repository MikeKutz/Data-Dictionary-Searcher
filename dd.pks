...
as
  ...
  */
  ...
  /* Add additional SEQ_ID row
     ...
     default is FALSE
  */
  PARAM_INCLUDE_SEQ_ID         "boolean_t" := FALSE_VALUE;
  ...
  SYSTEM_GENERATED_COLUMNS    constant "search_option_t" := power(2,2); -- requires >= 12.1.0.1
...
$END
                    ...
                    where
                      ...
                      ( -- filter EXCLUDE_OPTIONS
                        "Columns".EXCLUDE_OPTIONS is null
                        or not (
